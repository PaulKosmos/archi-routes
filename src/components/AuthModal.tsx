      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-6 relative">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">
            {mode === 'login' 
              ...
              : 'Присоединяйтесь к сообществу архитектурных исследователей'
            }
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="mt-4 w-full border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2"
          >
