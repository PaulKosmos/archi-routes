          ...
          >
            ...
            {ratingCount > 0 && (
              <div className="flex items-center mb-2 md:mb-3 bg-yellow-50 px-2 py-1.5 md:px-3 md:py-2 rounded-lg">
                ...
                <span className="text-xs md:text-sm text-gray-600 ml-1.5 md:ml-2">({ratingCount} оценок)</span>
              </div>
            )}
            ...
            <div className="border-t border-gray-100 pt-3 md:pt-4 mt-3 md:mt-4">
              <div className="flex items-center justify-between flex-wrap gap-2 md:gap-3">
                {/* Оценка звездами */}
                <div>
                  <p className="text-xs text-gray-600 mb-1.5 md:mb-2">Оцените обзор:</p>
