...
export default function NewsCard({
  ...
  if (variant === 'horizontal' || variant === 'featured') {
    return (
      <Link href={`/news/${news.slug}`}>
        <article className={`group bg-card border border-border overflow-hidden hover:shadow-md transition-shadow ${className}`}>
  ...
  return (
    <Link href={`/news/${news.slug}`}>
      <article className={`group bg-card border border-border overflow-hidden transition-shadow hover:shadow-md ${className}`}>
