// components/blog/blocks/editors/ImageTextLeftBlockEditor.tsx
// Редактор блока "Изображение слева + текст"
...
interface ImageTextLeftBlockEditorProps {
...
export default function ImageTextLeftBlockEditor({
  block,
  onChange,
  onDelete,
  onDuplicate,
    ...
    <div ref={setNodeRef} style={style}>
      ...
      >
        <div className="space-y-4">
          {/* Inline Layout: Изображение слева + Текст справа */}
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            {/* Текст справа с Rich Text Editor */}
