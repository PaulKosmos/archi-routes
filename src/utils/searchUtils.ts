...
export const SORT_OPTIONS = [
  { value: 'relevance', label: 'По релевантности', icon: '🎯' },
  { value: 'rating', label: 'По рейтингу', icon: '⭐' },
  { value: 'year', label: 'По году постройки', icon: '📅' },
  { value: 'name', label: 'По алфавиту', icon: '🔤' },
  { value: 'distance', label: 'По расстоянию', icon: '📍' },
  { value: 'recent', label: 'Недавно добавленные', icon: '🆕' }
] as const

// Варианты доступности
export const ACCESSIBILITY_OPTIONS = [
  { value: 'wheelchair', label: 'Доступно для инвалидных колясок', icon: '♿' },
  { value: 'blind', label: 'Доступно для слабовидящих', icon: '🦯' },
  { value: 'deaf', label: 'Доступно для слабослышащих', icon: '🤟' },
  { value: 'limited_mobility', label: 'Ограниченная подвижность', icon: '🚶' },
  { value: 'elevator', label: 'Есть лифт', icon: '🛗' },
  { value: 'ramp', label: 'Есть пандус', icon: '♿' },
  { value: 'parking', label: 'Парковка для людей с ОВЗ', icon: '🅿️' }
] as const
